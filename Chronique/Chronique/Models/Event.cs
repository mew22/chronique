...
namespace Chronique.Models
{
    public class Event : BaseModel, INotifyPropertyChanged
    {
        ...
        public Event(string title = null, string date = null, string mainArtist = null, string mainArtistId = null,
         string description = null, string providerId = null, string location = null, string photo_uri = null, string type = null, string providerUri = null)
        {
            Title = title;
            try
            {
        ...
        public DateTime Date { get { return date; } set { date = value; this.OnPropertyChanged("Date"); } }
        public string DateString { get
        {
            return date.ToString("dd MMMM, YYYY hh:mm:tt"); } set { DateTime.TryParse(value, out date); this.OnPropertyChanged("Date"); }
        }
        ...
        public string ProviderUri { get { return providerUri; } set { providerUri = value; this.OnPropertyChanged("ProviderUri"); } }
