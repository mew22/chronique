...
namespace Chronique.Models
{
    public class Event : BaseModel, INotifyPropertyChanged
    {
        ...
        public Event(string name = null, string date = null, string mainArtist = null, string mainArtistId = null,
         string description = null, string providerId = null, string location = null, string photo_uri = null, List<Track> trackList = null)
        {
            Name = name;
            Date = date;
