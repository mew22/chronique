...
//                    BlogLinkedInIcon = ImageSource.FromResource("Chronique.Images.SocialNetwork.Blog_LinkedIn.png"),
        ...
        internal string GenerateUriFb(string title)
        {
            ...
            return firstPart + title.Replace(" ", "-") + lastPart;
        }
        ...
        internal string GenerateUriLi(string title)
        {
            var firstPart =
        ...
        internal string GenerateUriGp(string title)
        {
            var firstPart =
